...
const ProjectDisplay = ({
  ...
  <div className="debug grid h-full grid-cols-1 grid-rows-3 items-center justify-items-center gap-x-4 gap-y-6 p-4 md:grid-rows-4 lg:grid-cols-8 lg:grid-rows-1 lg:justify-start lg:gap-x-2">
