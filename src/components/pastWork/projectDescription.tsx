...
const ProjectDescription = ({
  ...
  <>
    <div className="shadow-base col-span-1 row-span-5 grid size-full grid-cols-1 grid-rows-[auto_2fr_1fr] flex-col content-start rounded-lg border bg-white p-5 md:w-[600px] lg:w-full">
    ...
    <button
      className="shadow-base hover:shadow-base col-span-1 row-span-1 w-full rounded-lg bg-brand-purple p-1 font-bold text-white shadow-not-black hover:shadow-not-black md:w-1/2 lg:justify-self-end"
